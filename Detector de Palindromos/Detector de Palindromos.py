...
frase_nueva = "".join(frase.split()).lower()  #Se divide frase en palabras, se juntan sin espacio y se convierten a minuscula
palindromo = frase_nueva==frase_nueva[::-1]  #Se crea un flag True o False si frase_nueva = frase_nueva alrevez
